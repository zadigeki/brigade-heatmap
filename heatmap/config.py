...
class APIConfig:
    ...
    base_url: str = "http://10.10.80.189:12056"
    username: str = "admin"
    password: str = "21232f297a57a5a743894a0e4a801fc3"  # Should be MD5 hashed
    timeout: int = 30
...
API_CONFIG = APIConfig(
    base_url=os.getenv("BRIGADE_API_URL", "http://10.10.80.189:12056"),
...
DATABASE_CONFIG = DatabaseConfig(
    db_path=os.getenv("DATABASE_PATH", "devices.db"),
